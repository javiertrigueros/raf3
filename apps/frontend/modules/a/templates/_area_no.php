...
<?php else: ?>
  ...
  <?php if (!$refresh): ?>
    ...
    <div id="a-area-<?php echo "$pageid-$name" ?>" <?php echo ($editable) ? 'data-pageid="'.$pageid.'" data-name="'.$name.'"' : '' ?> >
  ...
  <?php if (!$refresh): ?>
    ...
    <div id="a-slots-<?php echo "$pageid-$name" ?>">
  <?php endif ?>
  ...
  <?php $i = 0; foreach ($slots as $permid => $slot): ?>
   ...
   <?php end_slot() ?>
    ...
    <div 
      ...
      data-permid="<?php echo $permid ?>" 
      <?php // Insert a data-width attribute if the slot had a width option (not all do) ?>
      <?php include_slot("a-slot-content-width-$pageid-$name-$permid") ?>
      id="a-slot-<?php echo "$pageid-$name-$permid" ?>"
    >
    ...
    <?php // End Slot Controls ?>   
      ...
      <div id="a-slot-content-<?php echo "$pageid-$name-$permid" ?>">
