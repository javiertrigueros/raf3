...
/**
 * arLavernaDoc form base class.
 *
 * @method arLavernaDoc getObject() Returns the current form's model object
 *
 * @package    alcoor
 * @subpackage form
 ...
 */
abstract class BasearLavernaDocForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'task_all'      => new sfWidgetFormInputText(),
      'task_complete' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'task_all'      => new sfValidatorInteger(array('required' => false)),
      'task_complete' => new sfValidatorInteger(array('required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'arLavernaDoc', 'column' => array('guid')))
    );

    $this->widgetSchema->setNameFormat('ar_laverna_doc[%s]');
