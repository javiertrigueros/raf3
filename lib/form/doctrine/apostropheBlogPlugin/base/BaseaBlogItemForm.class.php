...
abstract class BaseaBlogItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_save'                  => new sfWidgetFormInputCheckbox(),
      ...
      'disqus_thread_identifier' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'is_save'                  => new sfValidatorBoolean(array('required' => false)),
      ...
      'disqus_thread_identifier' => new sfValidatorString(array('max_length' => 100, 'required' => false)),
