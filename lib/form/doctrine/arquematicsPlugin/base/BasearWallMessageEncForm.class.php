...
/**
 * arWallMessageEnc form base class.
 *
 * @method arWallMessageEnc getObject() Returns the current form's model object
 *
 * @package    alcoor
 * @subpackage form
 ...
 */
abstract class BasearWallMessageEncForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_wall_message_enc[%s]');
