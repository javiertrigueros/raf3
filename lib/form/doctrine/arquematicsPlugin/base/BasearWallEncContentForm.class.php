...
/**
 * arWallEncContent form base class.
 *
 * @method arWallEncContent getObject() Returns the current form's model object
 *
 * @package    alcoor
 * @subpackage form
 ...
 */
abstract class BasearWallEncContentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_wall_enc_content[%s]');
