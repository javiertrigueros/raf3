...
/**
 * arGmapsLocateHasArWallMessage form base class.
 *
 * @method arGmapsLocateHasArWallMessage getObject() Returns the current form's model object
 *
 * @package    alcoor
 * @subpackage form
 ...
 */
abstract class BasearGmapsLocateHasArWallMessageForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_gmaps_locate_has_ar_wall_message[%s]');
