...
/**
 * arWallUpload form base class.
 *
 * @method arWallUpload getObject() Returns the current form's model object
 *
 * @package    alcoor
 * @subpackage form
 ...
 */
abstract class BasearWallUploadForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'gui_id'            => new sfWidgetFormInputText(),
      'user_id'           => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('User'), 'add_empty' => true)),
      'size'              => new sfWidgetFormInputText(),
      'is_image'          => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'is_image'          => new sfValidatorBoolean(array('required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'arWallUpload', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('ar_wall_upload[%s]');
