...
/**
 * arWallMessageEnc filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearWallMessageEncFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_wall_message_enc_filters[%s]');
