...
/**
 * arDropFileEnc filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearDropFileEncFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_drop_file_enc_filters[%s]');
