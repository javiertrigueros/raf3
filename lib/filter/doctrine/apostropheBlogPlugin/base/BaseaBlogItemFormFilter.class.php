...
abstract class BaseaBlogItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_save'                  => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      ...
      'disqus_thread_identifier' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'is_save'                  => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'disqus_thread_identifier' => new sfValidatorPass(array('required' => false)),
  ...
  public function addMessagesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('arWallMessageHasBlogItem.wall_message_id', $values)
    ;
  }
