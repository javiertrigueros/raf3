...
/**
 * arExcerptEnc filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearExcerptEncFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_excerpt_enc_filters[%s]');
