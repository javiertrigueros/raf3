...
/**
 * arLavernaDocDelete filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearLavernaDocDeleteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_laverna_doc_delete_filters[%s]');
