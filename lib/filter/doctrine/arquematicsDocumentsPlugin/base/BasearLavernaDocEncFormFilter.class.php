...
/**
 * arLavernaDocEnc filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearLavernaDocEncFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_laverna_doc_enc_filters[%s]');
