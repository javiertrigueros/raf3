...
/**
 * arLavernaDocFavorite filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearLavernaDocFavoriteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_laverna_doc_favorite_filters[%s]');
