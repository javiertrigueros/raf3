...
/**
 * arLavernaDocTrash filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearLavernaDocTrashFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_laverna_doc_trash_filters[%s]');
