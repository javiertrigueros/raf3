...
/**
 * arDiagramHasArWallMessage filter form base class.
 *
 * @package    alcoor
 * @subpackage filter
 ...
 */
abstract class BasearDiagramHasArWallMessageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'diagram_id'      => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Diagram'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('ar_diagram_has_ar_wall_message_filters[%s]');
