...
(function($) {
    ...
    return this.each(function () {
      ...
      _wrap.css({"color": "transparent", "position": "relative"});
      _self.css({"position": "absolute", "margin": 0, "padding": 0, "right": 0, "top": 0, "font-size": "100em", "z-index": 3, "opacity": 0});
      ...
      _selfparent.css({"height": _fakeinput.height() + "px", "width":"100%"});
      ...
      _self.change(function () {
        ...
        if(options.setvalue && _ph.length > 0) {
          ...
          _selfparent.css("width", _fakeinput.width() + "%");
        }
      });
    });
  };
