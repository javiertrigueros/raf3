...
!function( $ ) {
	...
	function UTCToday(){
		var today = new Date();
                //return UTCDate(today.getUTCFullYear(), today.getUTCMonth(), today.getUTCDate(), today.getHours(), today.getUTCMinutes(), today.getUTCSeconds(), 0);
	...
	var Datetimepicker = function(element, options) {
		...
		this.isRTL = dates[this.language].rtl || false;
                ...
                //this.formatHack = options.formatHack;
