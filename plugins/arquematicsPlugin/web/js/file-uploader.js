        ...
        var handler = new qq[handlerClass]({
            ...
            onComplete: function(id, fileName, result){
                ...
                if ((result) && (result.status ==200)){
                    ...
                    //añade la nueva id del
                    //fichero a la lista
                    //var values = $("#" + self._classes.uploadvalues).val();
                    //values = result.values.arWallUploadsId + ',' + values;
                    //$("#" + self._classes.uploadvalues).val(values);
                    
                    
                } else {
                    qq.addClass(item, self._classes.fail);
                    
                    if (((result) && (result.status ==500)) && result.errors){
                       self._options.showMessage(result.errors[0]); 
                    }
                }
