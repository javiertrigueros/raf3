...
<?php if ($image): ?>
<img class="<?php echo ($class)?$class:''; ?>" src='<?php echo url_for("@user_resource?type=arProfileUpload&name=".$image->getBaseName()."&format=".$image->getExtension()."&size=small") ?>' id='image'/>
<?php else: ?>
