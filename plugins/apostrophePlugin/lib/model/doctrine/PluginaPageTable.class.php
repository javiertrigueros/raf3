...
class PluginaPageTable extends Doctrine_Table
{
  ...
  public function checkUserPrivilege($privilege, $pageOrInfo, $user)
  {
    ...
    $event = new sfEvent(null, 'a.filterPageCheckPrivilege', array('privilege' => $privilege, 'user' => $user, 'pageInfo' => $pageOrInfo, 'user' => $user));
  ...
  */
  public static function retrieveById($id)
  {
    ...
    $q = Doctrine::getTable('aPage')->createQuery('c')
            ->where("c.id = ?", $id); 
    
    return $q->fetchOne();
  }
  
  public static function hasEnginePage($name)
  {
        $q = Doctrine::getTable('aPage')->createQuery('c')
                ->where("c.engine = ?", $name)
