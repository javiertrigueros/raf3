...
<ul class="a-ui a-controls a-media-footer-controls">
	<li class="a-media-footer-item-count"><?php echo __('%count% resources',array('%count%' => $pager->count()), 'apostrophe') ?></li>
	<li class="a-media-footer-separator a">|</li>
	<li class="a-media-footer-view-label"><?php echo __('view per page', null, 'apostrophe') ?></li>
