...
<th class="a-admin-text a-admin-list-th-name">
    <?php if ('name' == $sort[0]): ?>
        <?php echo link_to(__('Category', array(), 'apostrophe'), '@a_category_admin?sort=name&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc')) ?>
    ...
    <?php else: ?>
        <?php echo link_to(__('Category', array(), 'apostrophe'), '@a_category_admin?sort=name&sort_type=asc') ?>
    <?php endif; ?>
</th>
<?php end_slot(); ?>
...
<?php include_slot('a-admin.current-header') */ ?>
	...
	<th class="a-admin-category a-admin-list-th-aMediaItem">
		  <?php echo __('Media', array(), 'apostrophe') ?>
		</th>
	<?php end_slot(); ?>
...
<?php include_slot('a-admin.current-header') ?>
	...
	<th class="a-admin-category a-admin-list-th-aBlogPost">
		  <?php echo __('Blog Posts', array(), 'apostrophe') ?>
		</th>
	<?php end_slot(); ?>
...
<?php include_slot('a-admin.current-header') ?>
	...
	<th class="a-admin-category a-admin-list-th-aEvent">
		  <?php echo __('Events', array(), 'apostrophe') ?>
		</th>
	<?php end_slot(); ?>
