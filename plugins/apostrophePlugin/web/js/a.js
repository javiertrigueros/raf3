...
function aConstructor()
{
  ...
  */
  ...
  this.arAsSubmit = function(options) {

    var target = options['id'];

    var actAsSubmit = $(target);
    var actAsSubmitForm = actAsSubmit.closest('form');
   
    actAsSubmit.on("click",function(e)  
    {
        e.preventDefault();
        
        actAsSubmitForm.submit();
  ...
  this.enablePermissionsToggles = function()
  {
    ...
    $('.view-options-widget').change(function() {
        console.log($(this));
    ...
    //$('.view-options-widget').change();
    
    console.log($('.view-options-widget'));

    $("input[name='settings[edit_admin_lock]']").change(function()
    {
      var $nodeLi = $(this).parents('li');
    ...
    $("input[name='settings[edit_admin_lock]']").change();
  };
  ...
  this.enablePageSettingsButtons = function(options)
  {
    ...
    apostrophe.menuToggle({"button":"#a-page-settings-button","classname":"","overlay":false,
      "beforeOpen": function() {
        $.ajax({
            type:'POST',
            dataType:'html',
