...
class apostrophePluginConfiguration extends sfPluginConfiguration
{
  ...
  public function initialize()
  {
    ...
    //$this->dispatcher->connect('ar.fileAdded', array($this, 'listenMediaAdded'));
  ...
  public function listenMediaAdded($event, $results = false)
  {
      $itemAdded = $event['item'];
      
      //print_r($itemAdded);
      
      //Array ( [error] => 0 [name] => screen6.jpg [type] => image/jpeg [tmp_name] => /var/www/vhosts/raf6.com/httpdocs/data/a_writable/persistent_uploads/4787871bad7f2c75.file [size] => 217777 [validatedType] => image/jpeg [imageInfo] => Array ( [format] => jpg [width] => 960 [height] => 340 ) [newfile] => 1 [mime_type] => image/jpeg [extension] => jpg ) 
