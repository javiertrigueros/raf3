         ...
         'query_string' => 
           http_build_query(
             array_merge(
               ...
               "type" => "image",
               "label" => a_get_option($options, 'browseLabel', a_('You are creating a photo grid.')),
               "after" => a_url('aPhotoGridSlot', 'edit') . "?" . 
                 http_build_query(
                   array(
                     "slot" => $name, 
                     "slug" => $slug, 
...
<?php use_javascript("/apostropheExtraSlotsPlugin/js/jquery.lightbox.js"); ?>
