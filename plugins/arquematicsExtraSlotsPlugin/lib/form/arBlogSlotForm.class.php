<?php    
class arBlogSlotForm extends BaseForm
{
  protected $id;
  ...
  public function configure()
  {
    ...
    $choices = array('title' => a_('By Title'), 'tags' => a_('By Category And Tag'));
    ...
    $this->widgetSchema['categories_list']      = new sfWidgetFormDoctrineChoice(array('multiple' => false, 'model' => 'aCategory'));
    $this->validatorSchema['categories_list']   = new sfValidatorDoctrineChoice(array('model' => 'aCategory', 'multiple' => false, 'required' => false));

    $this->widgetSchema->setHelp('categories_list', a_('Filter Posts by Category'));
    ...
    $this->widgetSchema->setHelp('tags_list', a_('Filter Posts by Tag'));
