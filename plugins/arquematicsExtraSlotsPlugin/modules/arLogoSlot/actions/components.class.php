...
class arLogoSlotComponents extends aSlotComponents
{
    /**
   * DOCUMENT ME
   */
  protected function getButtonMedia()
  {
    ...
    else
    {
      ...
      //use_stylesheet("/arquematicsExtraSlotsPlugin/css/arquematicsExtraSlots.css"); 
      //include_component('arMedia','showPicture',array('mediaItem' => $item));
  ...
  public function executeEditView()
  {
    ...
    $this->options['height'] = 160;
      ...
      $this->form = new arLogoForm($this->id, $this->options);
      $value = $this->slot->getArrayValue();
      if (isset($value['url']))
      {
