         ...
         'query_string' => 
           http_build_query(
             array_merge(
               ...
               "after" => a_url('arGalleryResponsiveSlot', 'edit') . "?" . 
                 http_build_query(
                   array(
                     "slot" => $name, 
                     "slug" => $slug, 
...
<?php include_partial('arGalleryResponsiveSlot/gallery', array('items' => $items, 'id' => $id, 'options' => $options, 'placeholder' => count($items))) ?>