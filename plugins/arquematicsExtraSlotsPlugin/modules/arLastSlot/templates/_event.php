...
<div class="post entry clearfix latest">
			<div class="thumb">
                            <a href="<?php echo url_for('@a_event_show?slug='.$aBlogItem->getSlug()) ?>">
			...
			<h3 class="title">
                            <a href="<?php echo url_for('@a_event_show?slug='.$aBlogItem->getSlug()) ?>"><?php echo $aBlogItem->getTitle() ?></a>
                        </h3>
                         <p class="meta-info">
                        ...
                        <a href="<?php echo url_for('@a_event_show?slug='.$aBlogItem->getSlug()) ?>" class="more"><span><?php echo a_('Read More') ?></span></a>
 </div> <!-- end .post-->