...
<?php a_js_call('aBlog.slotEditView(?)', array('textAdd' => a_('Add Categories') ,'formName' => $form->getName(), 'autocompleteUrl' => a_url('aBlogAdmin', 'search'), 'class' => 'blog-posts', 'selfLabelSelector' => '#'.$w->renderId().'-title', 'debug' => false)) ?>
