		...
		this.each(function(){
			...
			function getCurrentMedia(init){
				...
				if (settings.useLarger ){
                                        ...
                                        {
                                          c = breakpoints[breakpoints.length-1];
                                        }
			...
			function setPicture(){
				...
				if(element.find('img').length === 0){
					...
					var prep = '<img src="' + sizes[currentMedia] + '"';
                                        prep += ' class="respondImg ' + element.attr('class') + '"';
				...
				if(settings.inlineDimensions){
					...
					$("<img/>").attr("src", $('img', element).attr("src")).load(function(){
						...
						//$('img', element).attr('width', this.width);
                                                $('img', element).attr('height', element.attr('height'));
						$('img', element).attr('width', element.attr('width'));
                                                $('img', element).show();
				    });
