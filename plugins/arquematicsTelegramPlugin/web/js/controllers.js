...
angular.module('myApp.controllers', [])
  ...
  .controller('AppToMenuController', function ($scope) {
   
    
    $scope.hasMovileWidth = function() {
  ...
  .controller('AppLoginController', function ($scope, $location, $timeout, MtpApiManager, ErrorService, gettext) {
    var options = {dcID: 1};
  ...
  .controller('AppIMController', function ($scope, $location, $routeParams, $modal, $rootScope, $modalStack, MtpApiManager, AppUsersManager) {
    ...
    $scope.openSettings = function () {
      $modal.open({
        templateUrl: '/arquematicsTelegramPlugin/js/partials/settings_modal.html',
    ...
    $scope.openContacts = function () {
      $modal.open({
        templateUrl: '/arquematicsTelegramPlugin/js/partials/contacts_modal.html',
      ...
      AppMessagesManager.getDialogs($scope.search.query, maxID, startLimit).then(function (dialogsResult) {
        ...
        if (dialogsResult.dialogs.length) {
          ...
          angular.forEach(dialogsResult.dialogs, function (dialog) {
            dialog = AppMessagesManager.wrapForDialog(dialog.top_message, dialog.unread_count);
            console.log(dialog);
  ...
  .controller('UserModalController', function ($scope, $location, $rootScope, $modalStack, AppUsersManager, NotificationsManager, AppMessagesManager, AppPeersManager, gettextCatalog) {
    ...
    $scope.flushHistory = function () {
      console.log(gettextCatalog.getString('Are you sure? This can not be undone!'));
      
      if (confirm(gettextCatalog.getString('Are you sure? This can not be undone!')) !== true) {
        return false;
      }
  ...
  .controller('ChatModalController', function ($scope, $timeout, $rootScope, AppUsersManager, AppChatsManager, MtpApiManager, NotificationsManager, AppMessagesManager, AppPeersManager, ApiUpdatesManager, gettextCatalog) {
