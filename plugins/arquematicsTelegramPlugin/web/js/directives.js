   ...
   .directive('placeholder', ['gettextCatalog', function (gettextCatalog) {
           ...
           function link(scope, el, attrs){
                ...
                $node.attr('placeholder',
                    gettextCatalog.getString($node.attr('placeholder')));
    ...
    /*
 .directive('arquematicsAdminMenu', function ($compile, $window) {
           ...
           function link(scope, el, attrs){
              ...
              scope.$watch(scope.userConfig,function() {
                if (scope.userConfig !== false)
                {
                    var $node =  $('#admin-cms-content');
                    $node.empty().append($(scope.userConfig.cms_admin_html) );
  ...
  .directive('myDialog', function() {
    return {
      ...
      scope: true,
      translude: false,
      templateUrl: '/arquematicsTelegramPlugin/js/partials/dialog.html'
    };
  })
  ...
  .directive('myContact', function() {
    return {
      ...
      scope: true,
      translude: false,
      templateUrl: '/arquematicsTelegramPlugin/js/partials/contact.html'
    };
  })
  ...
  .directive('myMessage', function() {
    return {
      ...
      scope: true,
      translude: false,
      templateUrl: '/arquematicsTelegramPlugin/js/partials/message.html'
    };
  })
