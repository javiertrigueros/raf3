...
abstract class PluginaEvent extends BaseaEvent
{
  ...
  public static $dateStatus = array('no_date' => 'no_date',
      'init_date' => 'init_date',
      'end_date' => 'end_date'
      );
  ...
  {
    //return url_for('@ar_blog_event_edit?id='.$this->getId());
    //return '@ar_blog_event_edit?id='.$this->getId();
    return '@a_event_show_id?id='.$this->getId();
  }
  ...
  {
      $ret = $this->isDateTimeDefined()?-1:aEvent::$dateStatus['no_date'];
      
      if ($ret < 0)
      {
         $ret = $this->hasEndDate()?aEvent::$dateStatus['end_date']:aEvent::$dateStatus['init_date'];
      }
      
      return $ret;
  }
  
  public function isDateTimeDefined()
  {
