...
<?php foreach ($this->configuration->getValue('list.display') as $name => $field): ?>
  ...
  <?php if(isset($filterFieldConfig[$name])): ?>
    ...
    <ul class="a-multi-title">
      <li><a href="#" class="a-btn a-sort-label alt">[?php echo __('<?php echo $field->getConfig('label') ?>', array(), 'apostrophe') ?]</a>
  ...
  <?php else: ?>
    <span class="a-simple-title">[?php echo __('<?php echo $field->getConfig('label') ?>', array(), 'apostrophe') ?]</span>
  <?php endif; ?>
