...
<table class="a-calendar">
	...
	<tr class="month">
		<th colspan="7">
			...
			<h4 class="title">
				<a href="<?php echo url_for(aUrl::addParams($filtersWithoutDate, array('year' => $calendar['year'], 'month' => date('m', strtotime($calendar['month']))))) ?>"><?php echo __($calendar['month'],array(),'blog') ?></a>
	...
	<tr class="days">
		<th class="day sunday"><?php echo __('Su',array(),'blog') ?></th>
		<th class="day monday"><?php echo __('M',array(),'blog') ?></th>
		<th class="day tuesday"><?php echo __('T',array(),'blog') ?></th>
		<th class="day wedsnesday"><?php echo __('W',array(),'blog') ?></th>
		<th class="day thursday"><?php echo __('Th',array(),'blog') ?></th>
		<th class="day friday"><?php echo __('F',array(),'blog') ?></th>
		<th class="day saturday"><?php echo __('S',array(),'blog') ?></th>																								
	</tr>	
	</thead>
	<tbody>
	...
	<tfoot>
		<tr>
			<td colspan="7">
				<a href="<?php echo url_for($filtersWithoutDate, array('year' => date('Y'), 'month' => date('m'), 'day' => date('d'))) ?>" class="icon a-events day-<?php echo date('d') ?> alt a-calendar-today"><span class="icon"></span><?php echo __('Today',array(),'blog') ?></a>
			</td>
		</tr>
	</tfoot>
</table>
