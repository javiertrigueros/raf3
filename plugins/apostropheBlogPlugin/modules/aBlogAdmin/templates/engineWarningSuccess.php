        ...
        <div class="profile-content">
            <div id="content" class="tab-content tab-content-bordered panel-padding tab-container-border">
                <div class="alert alert-danger alert-dark">
                    <strong><?php echo __('There is no blog page!', null, 'arquematics' ); ?></strong> 
                    <?php echo __("You don't currently have a blog engine page, please create one.", null, 'arquematics' ); ?>
                </div>
            </div>
        </div>
    </div>
