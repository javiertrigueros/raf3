...
<td class="a-admin-text a-column-status"><?php echo get_partial('aBlogAdmin/status', array('type' => 'list', 'a_blog_post' => $a_blog_post)) ?></td>
<td class="a-admin-date a-column-published_at"><?php echo false !== strtotime($a_blog_post->getPublishedAt()) ? format_date($a_blog_post->getPublishedAt(), "g") : '&nbsp;' ?></td>
