...
<?php include_partial('arNavigation/accordion', array('isCMSAdmin' => $isCMSAdmin,'nav' => $nav, 'maxDepth' => $depth, 'nest' => $nest, 'ulClass' => $ulClass, 'draggable' => $draggable, 'name' => $name, 'dragIcon' => $dragIcon, 'tabs' => true, 'class' => $class, 'active' => $active)) ?>