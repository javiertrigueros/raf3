...
<div class="a-options-section permissions a-accordion clearfix">
  ...
  <h3 class="a-permissions-heading head-menu-control a-view-permissions"><?php echo a_('View Permissions') ?></h3>
  ...
  <div class="accordion-content">
  	<div class="a-form-row a-page-permissions">
  	  ...
  	  <h4><?php echo a_('Who can see this page?') ?></h4>
          ...
          <?php echo $form['view_options']->render() ?>
    	  </div>
        ...
        <?php endif ?>
    	  ...
    	  <div class="a-page-permissions-view-extended">

		<hr class="a-hr" />

	    	<p class="a-help"><?php echo a_('Select Groups and/or Users who can view this page and subpages') ?></p>

      		<div class="a-page-permissions-section clearfix">
      			<h4><label><?php echo a_('Groups') ?></label></h4>
      			<?php echo $form['view_groups']->render() ?>
                        <?php /*// This div is replaced by JS ?>
      			<div class="a-page-permissions-widget clearfix" id="a-page-permissions-view-groups"></div>
      			<?php //a_js_call('apostrophe.enablePermissions(?)', array('id' => 'a-page-permissions-view-groups', 'hiddenField' => 'a_settings_settings_view_groups', 'name' => 'groups', 'removeLabel' => a_('Remove'), 'addLabel' => a_('+ Add Group'), 'extra' => false, 'applyToSubpagesLabel' => a_('apply to subpages'), 'hasSubpages' => $hasSubpages)) */?>
      		</div>

      		<div class="a-page-permissions-section clearfix">
      			<h4><label><?php echo a_('Users') ?></label></h4>
                        <?php echo $form['view_individuals']->render() ?>
      			<?php /* // This div is replaced by JS ?>
      			<div class="a-page-permissions-widget clearfix" id="a-page-permissions-view-individuals"></div>
        		<?php //a_js_call('apostrophe.enablePermissions(?)', array('id' => 'a-page-permissions-view-individuals', 'hiddenField' => 'a_settings_settings_view_individuals', 'name' => 'individuals', 'removeLabel' => a_('Remove'), 'addLabel' => a_('+ Add User'), 'extra' => false, 'applyToSubpagesLabel' => a_('apply to subpages'), 'hasSubpages' => $hasSubpages)) */?>
      		</div>
...
<?php if ($admin): ?>
  <div class="a-options-section permissions a-accordion clearfix">
    <h3 class="a-permissions-heading head-menu-control a-edit-permissions"><?php echo a_('Edit Permissions') ?></h3>
