...
<li data-depth="<?php echo ($node->getLevel() -1) ?>" data-menu-type="page" data-name="<?php echo $node->getName() ?>" data-url="<?php echo $node->getUrl() ?>" data-id="<?php echo $node->getPageId() ?>" class="menu-item menu-item-depth-<?php echo ($node->getLevel() -1) ?> menu-item-page menu-item-edit-inactive" id="menu-item-<?php echo $node->getId() ?>">
