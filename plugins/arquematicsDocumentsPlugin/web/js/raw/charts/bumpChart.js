(function(){
    ...
    var chart = raw.chart()
        .title('Bump Chart')
        .thumbnail("/arquematicsDocumentsPlugin/js/raw/imgs/bumpChart.png")
        .description("For continuous data such as time series, a bump chart can be used in place of stacked bars.")
