(function(){
    ...
    var chart = raw.chart()
        .title('Streamgraph')
        .thumbnail("/arquematicsDocumentsPlugin/js/raw/imgs/streamgraph.png")
        .description("For continuous data such as time series, a streamgraph can be used in place of stacked bars.")
