(function(){
    ...
    var chart = raw.chart()
        .title('Convex Hull')
        .description(
            "In mathematics, the convex hull is the smallest convex shape containing a set o points. Applied to a scatterplot, it is useful to identify points belonging to the same category.")
        .thumbnail("/arquematicsDocumentsPlugin/js/raw/imgs/convexHull.png")
        .model(points)
