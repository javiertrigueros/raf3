...
mindmaps.SaveDocumentView = function() {
  ...
  var $hddSaveButton = $("#button-save-hdd").button().downloadify({
    ...
    swf : 'http://www.alcoor.com/arquematicsWorkflowPlugin/images/mindmaps/downloadify.swf',
    downloadImage : 'http://www.alcoor.com/arquematicsWorkflowPlugin/images/mindmaps/transparent.png',
    width : 65,
    height : 29,
    append : true
  });
