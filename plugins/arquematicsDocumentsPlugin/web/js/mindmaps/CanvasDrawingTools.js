...
mindmaps.CanvasBranchDrawer = function() {
  ...
  this.render = function(ctx, depth, offsetX, offsetY, $node, $parent, color,
    ...
    var lineWidth = mindmaps
                        .CanvasDrawingUtil
                        .getLineWidth(zoomFactor, depth);
    ...
    var pLineWidth = mindmaps
                        .CanvasDrawingUtil
                        .getLineWidth(zoomFactor,depth - 1);
...
mindmaps.TextMetrics = (function() {
  ...
  return {
    ...
    getTextMetrics : function(node, zoomFactor, text) {
      ...
      var minWidth = node.isRoot() ? 
            this.ROOT_CAPTION_MIN_WIDTH : this.NODE_CAPTION_MIN_WIDTH;
