...
define([
    ...
    'apps/notes/show/views/noteCMDButtons',
], function (_, App, Marionette, NoteModel,  FilesCollection , NoteView, NoteCMDButtons) {
    'use strict';
    ...
    Show.Controller = Marionette.Controller.extend({
        ...
        showContent: function () {
            ...
            App.toolButtoms.show(new NoteCMDButtons(args));
        },
