...
define([
    ...
    'i18next',
    'devicejs',
    'apps/encryption/arquematicsAuth',
    'marionette'
        ...
        require([
          ...
          $.when(ArquematicsAuth())
           ...
           App.settings.appLang = userInfo.lang;
            ...
            var lng = {                           
                resGetPath      : '/arquematicsDocumentsPlugin/js/explorer/app/locales/' + App.settings.appLang + '/__ns__.json',
            ...
            //configs.createProfile('notes-db');
            
            //App.settings = configs.getConfigs();

            App.currentProfile = URI.getProfile();
            //App.currentProfile = App.userInfo.user.id + 'notes-db';
