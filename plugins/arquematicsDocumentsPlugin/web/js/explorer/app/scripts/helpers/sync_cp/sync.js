...
define([
    ...
    'helpers/sync/alcoor-sync-adapter',
], function (_, $, Removed,  RemoteSync, AlcoorSync) {
    'use strict';
    ...
    Sync.prototype = {
        ...
        localNeedsUpdate: function (model) {
            ...
            // User removed it locally
                ...
                console.log('cloud read to go');
                $.when( this.cloud('read', model) ).then(function (m) {
                        console.log('set del cloud');
                        model.set(m);
                        self.updateLocal(model, local, d);
                 });
            }
